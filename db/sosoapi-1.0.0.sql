...
-- ----------------------------
INSERT INTO `t_api_doc` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', 'sosoapi_demo', '该demo主要用于汇集常见的接口编辑事例。\n<br/>\n接口测试过程中如果出现ajax跨域请求问题可参考\"常见问题->线下部署\"中的跨域请求相关资料。\n<br/>\n<br/>\n技术交流群:305629848', 'www.sosoapi.com', '/demo', '0', '1', '', '', '', '1.0.0');
...
-- Records of t_inter
-- ----------------------------
INSERT INTO `t_inter` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', '2', '新增用户(自定义参数)', '/user/complex/add.htm', 'POST', 'HTTP', null, '新增用户(自定义参数)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('2', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '2', '查询用户列表(多层嵌套)', '/user/complex/list.htm', 'GET', 'HTTP', null, '查询用户列表(多层嵌套)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('3', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '2', '获取用户详情(多层嵌套)', '/user/complex/{userId}/info.htm', 'GET', 'HTTP', null, '获取用户详情(多层嵌套)', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('4', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', '新增用户', '/user/simple/add.htm', 'POST', 'HTTP', null, '新增用户信息', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('5', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', '查询用户列表', '/user/simple/list.htm', 'GET', 'HTTP', null, '获取用户列表', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('6', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', '删除用户', '/user/simple/{userId}/del.htm', 'DELETE', 'HTTP', null, '删除指定用户', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('7', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', '查询用户', '/user/simple/{userId}/info.htm', 'GET', 'HTTP', null, '查询用户信息', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('8', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', '更新用户', '/user/simple/{userId}/update.htm', 'POST', 'HTTP', null, '更新用户信息', 'application/json', 'application/json', '0', '0');
INSERT INTO `t_inter` VALUES ('9', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '1', '上传图片', '/user/simple/{userId}/upload.htm', 'POST', 'HTTP', null, '上传', 'application/json', 'application/json', '0', '0');
...
-- ----------------------------
INSERT INTO `t_inter_param` VALUES ('1', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', 'userInfo', null, '用户信息', 'cust_json', 'json', 'body', '1', null, '{\n	\"email\": \"string,邮箱\",\n        \"nickName\": \"string,昵称\"\n}', null, null);
INSERT INTO `t_inter_param` VALUES ('2', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '3', 'userId', null, '用户id', 'sys_integer_int64', 'int64', 'path', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('3', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '4', 'email', null, '邮箱', 'sys_string', '', 'formData', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('4', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '4', 'nickName', null, '昵称', 'sys_string', '', 'formData', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('5', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '4', 'age', null, '年龄', 'sys_integer_int32', 'int32', 'formData', '0', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('6', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '6', 'userId', null, '用户id', 'sys_integer_int64', 'int64', 'path', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('7', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '7', 'userId', null, '用户id', 'sys_integer_int64', 'int64', 'path', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('8', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '8', 'userId', null, '用户id', 'sys_integer_int64', 'int64', 'path', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('9', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '8', 'nickName', null, '昵称', 'sys_string', '', 'query', '1', null, null, null, null);
INSERT INTO `t_inter_param` VALUES ('10', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '9', 'userId', null, '', 'sys_integer_int64', 'int64', 'path', '1', null, null, null, '');
INSERT INTO `t_inter_param` VALUES ('11', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '9', 'img', null, '', 'sys_file', '', 'formData', '1', null, null, null, '');
...
-- ----------------------------
INSERT INTO `t_inter_resp` VALUES ('1', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '1', 'default', null, '默认响应', 'sys_object', null, '0', '0', '[{\"code\":\"userId\",\"description\":\"用户id\",\"type\":\"sys_integer_int64\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('2', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '2', 'default', null, '默认响应', 'sys_object', null, '0', '0', '[{\"code\":\"data\",\"description\":\"响应信息\",\"type\":\"sys_object\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"totalCount\",\"description\":\"总记录数\",\"type\":\"sys_integer_int32\",\"nodeId\":\"1010\",\"parentId\":\"10\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"list\",\"description\":\"用户列表\",\"type\":\"sys_array\",\"nodeId\":\"1011\",\"parentId\":\"10\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"SimpleUserInfo\",\"description\":\"用户列表\",\"type\":\"sys_ref\",\"refSchemaId\":2,\"nodeId\":\"101110\",\"parentId\":\"1011\",\"childList\":[],\"childRefSchemaIdList\":[2]},{\"code\":\"errorCode\",\"description\":\"错误码\",\"type\":\"sys_string\",\"nodeId\":\"11\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('3', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '3', 'default', null, '默认响应', 'sys_object', null, '0', '0', '[{\"code\":\"addressList\",\"description\":\"地址列表\",\"type\":\"sys_array\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"street\",\"description\":\"街道名称\",\"type\":\"sys_string\",\"nodeId\":\"1010\",\"parentId\":\"10\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"city\",\"description\":\"城市名称\",\"type\":\"sys_string\",\"nodeId\":\"1011\",\"parentId\":\"10\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"nickName\",\"description\":\"昵称\",\"type\":\"sys_string\",\"nodeId\":\"11\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"age\",\"description\":\"年龄\",\"type\":\"sys_integer_int32\",\"nodeId\":\"12\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"userId\",\"description\":\"用户id\",\"type\":\"sys_integer_int64\",\"nodeId\":\"13\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('4', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '3', 'error', null, '错误信息', 'sys_ref', '1', '0', '0', null, null, '0');
INSERT INTO `t_inter_resp` VALUES ('5', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '3', '001', null, '管理员', 'sys_object', null, '0', '0', '[{\"code\":\"admin\",\"description\":\"管理员信息\",\"type\":\"sys_ref\",\"refSchemaId\":2,\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[2]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('6', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '4', 'default', null, '默认响应', 'sys_object', null, '0', '0', '[{\"code\":\"userId\",\"description\":\"用户id\",\"type\":\"sys_integer_int64\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('7', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '4', '404', null, '无法找到对应服务', 'sys_string', null, '0', '0', null, null, '0');
INSERT INTO `t_inter_resp` VALUES ('8', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '5', 'default', null, '默认响应', 'sys_array', null, '0', '0', '[{\"code\":\"email\",\"description\":\"用户邮箱\",\"type\":\"sys_string\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"nickName\",\"description\":\"用户昵称\",\"type\":\"sys_string\",\"nodeId\":\"11\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"userId\",\"description\":\"用户id\",\"type\":\"sys_integer_int64\",\"nodeId\":\"12\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', null, '0');
INSERT INTO `t_inter_resp` VALUES ('9', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '6', 'default', null, '默认响应', 'sys_ref', '1', '0', '0', null, null, '0');
INSERT INTO `t_inter_resp` VALUES ('10', '2020-03-31 17:00:01', '2020-03-31 17:00:01', '1', '7', 'default', null, '默认响应', 'sys_ref', '2', '0', '0', null, null, '0');
INSERT INTO `t_inter_resp` VALUES ('11', '2020-03-31 17:00:02', '2020-03-31 17:00:02', '1', '8', 'default', null, '默认响应', 'sys_ref', '1', '0', '0', null, null, '0');
...
-- Records of t_module
-- ----------------------------
INSERT INTO `t_module` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', null, '入门', '', '0');
INSERT INTO `t_module` VALUES ('2', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', null, '进阶', '', '50');
...
-- Records of t_proj
-- ----------------------------
INSERT INTO `t_proj` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', 'sosoapi_demo', null, '该demo主要用于汇集常见的接口编辑事例。\n<br/>\n接口测试过程中如果出现ajax跨域请求问题可参考\"常见问题->线下部署\"中的跨域请求相关资料。\n<br/>\n<br/>\n技术交流群:305629848', 'open');
...
-- ----------------------------
INSERT INTO `t_proj_mem` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', '1', 'admin', null);
...
-- ----------------------------
INSERT INTO `t_resp_schema` VALUES ('1', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', null, 'ErrorCode', null, '错误码', '[{\"code\":\"errorCode\",\"description\":\"错误编码\",\"type\":\"sys_string\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"errorMsg\",\"description\":\"错误提示信息\",\"type\":\"sys_string\",\"nodeId\":\"11\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', 'sys_object', null);
INSERT INTO `t_resp_schema` VALUES ('2', '2020-03-31 17:00:00', '2020-03-31 17:00:00', '1', null, 'SimpleUserInfo', null, '简单用户信息', '[{\"code\":\"nickName\",\"description\":\"昵称\",\"type\":\"sys_string\",\"nodeId\":\"10\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"email\",\"description\":\"邮箱\",\"type\":\"sys_string\",\"nodeId\":\"11\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]},{\"code\":\"age\",\"description\":\"年龄\",\"type\":\"sys_integer_int32\",\"nodeId\":\"12\",\"parentId\":\"\",\"childList\":[],\"childRefSchemaIdList\":[]}]', 'sys_object', null);
...
-- ----------------------------
INSERT INTO `t_user_basic` VALUES ('1', '2020-03-31 16:46:02', '2020-03-31 16:46:02', null, 'admin@qq.com', 'b5cf498b70a176efeacbc5b07d88e0da76a7f4cb', '1', 'admin', '0', null, '0:0:0:0:0:0:0:1');
...
-- ----------------------------
INSERT INTO `t_user_detail` VALUES ('1', '2020-03-31 16:46:02', '2020-03-31 16:46:02', '1', null, null, null, null, null, null, 'admin', null, null, null);
...
-- ----------------------------
INSERT INTO `t_user_ext` VALUES ('1', '2020-03-31 16:46:46', '2020-03-31 16:46:46', '1', '2020-03-31 16:58:35');
...
-- ----------------------------
INSERT INTO `t_user_login` VALUES ('1', '2020-03-31 16:46:02', '2020-03-31 16:51:54', '2020-03-31 16:58:34', '0', '3', '0:0:0:0:0:0:0:1', '1', 'email', 'online', null);
...
-- ----------------------------
INSERT INTO `t_user_token` VALUES ('1', '2020-03-31 16:46:47', '2020-03-31 16:46:47', '1', '0:0:0:0:0:0:0:1', '4258e33ced2155af54fc0ad8575c854d', '2016-10-25 16:58:35');
